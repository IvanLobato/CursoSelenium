...
//Se hereda el Poligono de la clase Poligono
public class Rectangulo extends Poligono {
	...
	public Rectangulo (double base, double altura) {
		super (4); //manda llamar a la clase padre, que es el contructor
		this.base = base;
		this.altura = altura;
	}
	//Encapsulacion
	...
	@Override //manda a llamar el metodo (herencia)
